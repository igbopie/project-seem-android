 ...
 */
public class SpinnerImageViewV5 extends RelativeLayout {
    ...
    public SpinnerImageViewV5(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        inflater.inflate(R.layout.component_square_image_v5, this, true);
