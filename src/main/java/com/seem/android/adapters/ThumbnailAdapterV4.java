 ...
 */
public class ThumbnailAdapterV4 extends BaseAdapter {

    Context context;
    List<Item> items = new ArrayList<Item>();
    ItemSelectedListener repliesListener;
    ItemSelectedListener threadViewListener;
    public ThumbnailAdapterV4(Context context, ItemSelectedListener repliesListener, ItemSelectedListener threadViewListener) {
        super();
